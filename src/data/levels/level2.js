  ...
  scenes: [
    {
      ...
      definition: {
        ...
        aspects: [
          ...
          { icon: "🔗", title: "Enterprise = Unternehmen", text: "Beide Begriffe werden synonym verwendet, eine abweichende Definition gibt es in dieser Veranstaltung nicht" }
        ],
        nexusContext: "NEXUS Corp ist ein Unternehmen: Das Ziel ist die Deckung fremden Bedarfs, denn Industriekunden kaufen Hardware, die NEXUS produziert und vertreibt. Der Mehrwert für Stakeholder ist der Maßstab für Erfolg.",
      },
      question: "Was unterscheidet ein Unternehmen von einem Haushalt als Betriebsform?",
      answers: [
        { text: "Unternehmen zahlen Steuern, Haushalte nicht. Die steuerliche Behandlung ist ein wichtiges rechtliches Unterscheidungsmerkmal, das die gesamte Buchführung und Organisationsstruktur beeinflusst.", correct: false, feedback: "Das ist weder trennscharf noch die definitorische Unterscheidung. Der entscheidende Unterschied liegt in der Ausrichtung auf fremden vs. eigenen Bedarf." },
        { text: "Ein Unternehmen hat mehr Mitarbeitende als ein Haushalt. Die Anzahl der Beschäftigten bestimmt, welche organisatorischen Strukturen notwendig sind und welche Systeme eingesetzt werden müssen.", correct: false, feedback: "Die Unterscheidung ist nicht quantitativ. Ein Einpersonenunternehmen ist trotzdem ein Unternehmen, ein Großhaushalt bleibt ein Haushalt." },
    ...
    },
    {
      ...
      charMessage: "Das Wort 'Organisation' fällt bei uns täglich dutzende Male. Aber was meinen wir damit genau? Hat NEXUS Corp eine Organisation, oder ist NEXUS Corp eine Organisation?",
      definition: {
        term: "Organisation",
      ...
      answers: [
        ...
        { text: "Beides ist gleichwertig, die Unterscheidung ist rein sprachlich. In der modernen Managementliteratur werden beide Perspektiven oft synonym verwendet, da sie letztlich dieselbe Realität aus verschiedenen Blickwinkeln beschreiben.", correct: false, feedback: "Die Unterscheidung ist konzeptionell bedeutsam: Sie bestimmt, ob Organisation als festes Merkmal einer Einheit oder als gestaltbares Werkzeug verstanden wird." },
        { text: "NEXUS Corp ist eine Organisation. Der Begriff beschreibt die Einheit als Ganzes. Als Institution mit klarer Struktur, Hierarchien und definierten Rollen ist NEXUS Corp ein typisches Beispiel für eine formale Organisation.", correct: false, feedback: "Das wäre der institutionelle Organisationsbegriff. Die Vorlesung verwendet eine analytisch-gestaltende Perspektive, die Organisation als gestaltbares Instrument versteht." }
      ],
    },
    {
      ...
      definition: {
        ...
        nexusContext: "NEXUS Corp hat eine klare Aufbauorganisation: Tom leitet Logistik, Carlos den Vertrieb. Aber der Ablauf einer Kundenbestellung, also Angebot, Kommissionierung, Versand, Rechnung, ist raumzeitlich nicht strukturiert.",
      },
      ...
      answers: [
        { text: "Problem (1) ist Ablauforganisation (Prozessverantwortung), Problem (2) ist Aufbauorganisation (strukturelle Ineffizienz). Wer für Reklamationen zuständig ist, hängt davon ab, wie der Reklamationsprozess zeitlich und räumlich strukturiert ist, das ist eine Frage der Prozessgestaltung.", correct: false, feedback: "Die Zuordnung ist vertauscht. Zuständigkeit ist eine Strukturfrage (Aufbau), Prozessdauer ist eine Ablauffrage." },
        { text: "Beide Probleme betreffen die Ablauforganisation, da es um operative Abläufe geht. Sowohl Zuständigkeitsfragen als auch Prozessabläufe sind dynamische Phänomene, die sich ständig verändern und daher beide zur Ablauforganisation gehören.", correct: false, feedback: "Problem (1) ist eine Zuständigkeitsfrage: Wer ist verantwortlich? Das ist Aufbauorganisation. Problem (2) betrifft die raumzeitliche Strukturierung, das ist Ablauforganisation." },
    ...
    },
    {
      ...
      answers: [
        { text: "Weil Systeme möglichst geschlossen sein sollten, um solche Einflüsse zu vermeiden. Geschlossene Systeme sind stabiler, sicherer und besser steuerbar. Unternehmen sollten externe Einflüsse soweit wie möglich abschirmen.", correct: false, feedback: "Unternehmen sind per Definition offene Systeme. Abgeschlossenheit wäre betriebswirtschaftlich unmöglich und unerwünscht." },
        { text: "Weil es die Kosten erhöht und damit den Gewinn mindert. Aus betriebswirtschaftlicher Sicht ist die Kostenauswirkung das wichtigste Kriterium für die strategische Relevanz eines externen Ereignisses.", correct: false, feedback: "Das ist eine betriebswirtschaftliche Konsequenz, aber nicht die systemtheoretische Begründung der Relevanz." },
    ...
    },
    {
      ...
      definition: {
        ...
        aspects: [
          ...
          { icon: "⚙️", title: "Betriebliche Aufgaben", text: "IS tragen zur Bewältigung konkreter betrieblicher Aufgaben bei, sind aber kein Selbstzweck" },
      ...
      question: "Lena sagt: 'Unser Informationssystem ist defekt.' Tom antwortet: 'Wie bitte, alle Server laufen doch einwandfrei!' Was versteht Tom falsch?",
      answers: [
        { text: "Lena meint eigentlich das Anwendungssystem, sie benutzt nur den falschen Begriff. Lena ist Analystin, keine IT-Architektin. Es ist verständlich, dass sie IS und AS als Synonyme verwendet, auch wenn das konzeptionell nicht ganz korrekt ist.", correct: false, feedback: "Lena verwendet den Begriff korrekt. Sie diagnostiziert eine IS-Dysfunktion: Die Informationsversorgung der betrieblichen Aufgaben funktioniert nicht." },
        ...
        { text: "Tom hat Recht, wenn die Server laufen, ist das IS technisch intakt. Technische Verfügbarkeit ist die Grundvoraussetzung jedes funktionierenden Informationssystems. Ohne stabile Server gibt es keine verlässliche Informationsversorgung.", correct: false, feedback: "Server-Verfügbarkeit ist eine notwendige, aber keine hinreichende Bedingung für ein funktionierendes IS." }
      ],
    },
    {
      ...
      answers: [
        { text: "Weil Informationssysteme in der Praxis immer Kompromisse darstellen, kein System kann alle Anforderungen aller Nutzergruppen gleichzeitig vollständig erfüllen.", correct: false, feedback: "Das ist zwar pragmatisch richtig, aber nicht die konzeptionelle Antwort. Es geht um die präzise Unterscheidung: AS ist nicht gleich IS." },
        ...
        { text: "Weil SAP zu komplex für einen Mittelständler ist. SAP wurde für Großkonzerne entwickelt und überfordert mittelständische Unternehmen durch seine Komplexität, das ist das eigentliche Problem in Carlos' Aussage.", correct: false, feedback: "Das ist eine praktische Einschätzung, aber nicht die konzeptionelle Antwort. Die Frage zielt auf das Verhältnis von AS und IS." }
      ],
    },
    {
