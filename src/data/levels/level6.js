export const L6 = {
  ...
  scenes:[
      ...
      ] },
    {
      ...
      answers: [
        { text: "SWOT-Analyse: Priyas SAP-Expertise ermöglicht es NEXUS, eine externe Marktchance zu ergreifen, nämlich den wachsenden Bedarf an SAP-kompetenten IT-Dienstleistungen für andere Unternehmen.", correct: false, feedback: "Priya ist eine interne Ressource. In der SWOT wäre sie unter Strengths einzuordnen. Die zugrunde liegende Perspektive ist der Resource-Based View." },
        { text: "Market-Based View: SAP-Expertise stellt eine branchenweite Markteintrittsbarriere dar, weil Konkurrenten ohne entsprechendes Know-how nicht so schnell SAP-basierte Systeme einführen können.", correct: false, feedback: "Priyas Expertise ist eine interne Ressource. Das ist eine andere Perspektive." },
        { text: "Resource-Based View: Eine seltene, wertvolle interne Kompetenz stellt einen schwer kopierbaren Wettbewerbsvorteil dar.", correct: true, feedback: "Genau. Der RBV erklärt Wettbewerbsvorteile durch einzigartige Ressourcen. Priyas SAP-Expertise ist wertvoll, selten und schwer imitierbar." }
      ] },
    {
