export const L5 = {
  ...
  scenes:[
    {
      id: "5_1", type: "definition", charKey: "tom",
    ...
    {
      id: "5_2", type: "definition", charKey: "priya",
      charMessage: "Prozesse in Prosa zu beschreiben führt zu Missverständnissen, jeder liest es anders. Deshalb gibt es eine standardisierte visuelle Sprache dafür: BPMN.",
      definition:{ term: "BPMN (Business Process Model and Notation)", summary: "BPMN ist ein international standardisierter grafischer Notationsstandard zur Modellierung von Geschäftsprozessen.",
        aspects: [
          ...
          { icon: "🏊", title: "Swimlanes / Pools", text: "Horizontale Bahnen, die zeigen, wer welche Aufgabe ausführt: Abteilungen, Rollen, Systeme" }
        ],
    ...
    {
      id: "5_3", type: "matching", charKey: "priya",
    ...
    {
      id: "5_4", type: "definition", charKey: "tom",
  ...
  outro: {
    charKey: "tom",
    message: "Ich habe mein ganzes Berufsleben Prozesse im Kopf getragen. Jetzt sehe ich, dass das keine Stärke war, sondern ein Risiko für das Unternehmen. Was in meinem Kopf ist, gehört in ein Prozessmodell.",
    xp: 280,
    badge: "🔄 Prozessdenker"
  },
};
